...
export function RundownWorkspace() {
  ...
  const right = (
    <WorkspacePanel heading="Placement preview" variant="preview">
      <ProfileSelector profiles={["desktop", "mobile", "tv"]} selected={previewProfile} onSelect={(p) => setPreviewProfile(p as "desktop" | "mobile" | "tv")} label="Placement preview profile" />
