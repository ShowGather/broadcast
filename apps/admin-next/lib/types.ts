...
export interface PresentationInstanceDefinition {
  id: string;
  kind: "lower-third" | "scorebug" | "ticker" | "alert" | "sponsor" | "clock" | "live-badge" | "poll" | "custom";
  label: string;
  enabled: boolean;
}
...
export type LayoutAnchor = "top-left" | "top-centre" | "top-right" | "centre-left" | "centre" | "centre-right" | "bottom-left" | "bottom-centre" | "bottom-right";

export interface LayoutDefinition {
  instanceId: string;
  placementByProfile: Partial<Record<LayoutProfile, {
